...
# Maintainer name
# Default (if not set): N/A
SHRP_MAINTAINER := Zinger

# Recovery Type (for "About" section only)
# Default (if not set): N/A
SHRP_REC_TYPE := Treble # or Normal or SAR

# Device Type (for "About" section only)
# Default (if not set): N/A
SHRP_DEVICE_TYPE := A_Only # or A/B

# Your device's recovery path, dont use blindly
# No default
SHRP_REC := /dev/block/sde-50
